module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			...
			js: {
				src: ['src/polyfill.closest.legacy.js', 'src/polyfill.getMatchedCSSRules.js', 'node_modules/raf.js/raf.js', 'src/polyfill.object-fit.core.js'],
		...
		watch: {
			js: {
				files: [
					...
					'src/polyfill.closest.legacy.js',
